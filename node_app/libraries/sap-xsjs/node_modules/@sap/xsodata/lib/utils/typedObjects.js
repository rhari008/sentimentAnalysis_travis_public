...
Time.prototype.toSqlHana = function toSqlHana(context, parameter) {
    var value = uriToDb['Edm.Time'](this.value, 'TIME');
...
DateTime.prototype.toSqlHana = function (context, parameter) {
    var value = uriToDb['Edm.DateTime'](this.value, 'TIMESTAMP');
    parameter.push(value);
    return '?';
};
...
EdmString.prototype.toSqlHana = function toSqlHana(context, parameter) {
    var value = uriToDb['Edm.String'](this.string, 'VARCHAR');
    parameter.push(value);
    return '?';
};
...
Binary.prototype.toSqlHana = function toSqlHana(context, parameter) {
    var value = uriToDb['Edm.Binary'](this.value, 'VARBINARY');
...
//here only if null is supported
    ...
    var left = first.toSqlHana(context, pLeft);
    var right = second.toSqlHana(context, pRight);
...
BinaryOperator.prototype.toSqlHana = function toSqlHana(context, parameter) {
    ...
    var left = this.left.toSqlHana(context, pLeft);
    var right = this.right.toSqlHana(context, pRight);
...
UnaryOperator.prototype.toSqlHana = function toSqlHana(context, parameter) {
    var p = [];
    var value = this.value.toSqlHana(context, p);
...
Method.prototype.toSqlHana = function toSqlHana(context, parameter) {
    ...
    switch (this.method) {
        case exports.STARTSWITH  :
            ...
            sql += ' LIKE ';
            sql += 'concat(' + this.parameter[1].toSqlHana(context, p1) + ',\'%\')';
            sql += ')';
        ...
        case exports.SUBSTRINGOF :
            ...
            sql += ' LIKE ';
            sql += 'concat(\'%\',' +
                'concat(' + this.parameter[0].toSqlHana(context, p1) + ',\'%\')' +
                ')';
            sql += ')';
            parameter.push.apply(parameter, p0);
            parameter.push.apply(parameter, p1);
...
Parenthesis.prototype.toSqlHana = function toSqlHana(context, parameter) {
    var p = [];
    var ret = '(' + this.value.toSqlHana(context, p) + ')';
    parameter.push.apply(parameter, p);
    return ret;
};
...
Property.prototype.toSqlHana = function toSqlHana(context) {
    var ret = '';
    var table = (this.table ? this.table : context.table);
    if (table) {
        ret += '"' + table + '"' + ".";
    }
    ret += '"' + this.property + '"';
...
OrderBy.prototype.toSqlHana = function toSqlHana(context, parameter) {
    var sql = '';
    var clonedContext = cloneContextWithNoAlias(context);
...
function createApplyConverter() {
    var childPropertyNames = [].slice.call(arguments);
