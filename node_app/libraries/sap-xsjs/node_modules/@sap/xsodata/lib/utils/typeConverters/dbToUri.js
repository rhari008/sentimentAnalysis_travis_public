...
dbToUri.DATE = function dbToUriDATE(dbValue) {
    /* in    "1753-01-01"                   */
...
dbToUri.TIME = function dbToUriTIME(dbValue) {
    /* in    "00:00:00"                     */
    /* out   "time'PT0H0M0S'"                     */
    /* in    "23:59:59"                     */
...
dbToUri.SECONDDATE = function dbToUriSECONDDATE(dbValue) {
    ...
    /*--->'Edm.DateTime'                    */
    return "datetime'" + dbValue + ".0000000'";
};
...
dbToUri.TIMESTAMP = function dbToUriTIMESTAMP(dbValue) {
    ...
    return "datetime'" + converterTools.datetime7(dbValue) + "'";
