...
exports.createLinksStatements = function (context, isDeleteScenario) {
	...
	createStatementContainer(sqlContext, isDeleteScenario);
};

function createStatementContainer(sqlContext, isDeleteScenario) {
    ...
    if (sqlContext.context.db.isExternalHandledConnection === true) {
        ...
        dbSeg.sql.stmContainer.createTmpOldTruncate = sql.buildTableStatement(sql.Truncate, sqlContext,
            dbSeg.sql.stmContainer.createTmpOld.table);

        dbSeg.sql.stmContainer.createPrincipalTruncate = sql.buildTableStatement(sql.Truncate, sqlContext,
            dbSeg.sql.stmContainer.createPrincipal.table);

        dbSeg.sql.stmContainer.createDependentTruncate = sql.buildTableStatement(sql.Truncate, sqlContext,
            dbSeg.sql.stmContainer.createDependent.table);
        ...
        dbSeg.sql.stmContainer.createTmpOldDrop = sql.buildTableStatement(sql.Drop, sqlContext,
            dbSeg.sql.stmContainer.createTmpOld.table);

        dbSeg.sql.stmContainer.createPrincipalDrop = sql.buildTableStatement(sql.Drop, sqlContext,
            dbSeg.sql.stmContainer.createPrincipal.table);

        dbSeg.sql.stmContainer.createDependentDrop = sql.buildTableStatement(sql.Drop, sqlContext,
            dbSeg.sql.stmContainer.createDependent.table);
    }
}
...
exports.createMNStatementContainer = function createMNStatementContainer(sqlContext) {
