...
exports.HandlerOptions = function HandlerOptions(init) {
    ...
    /**
     * Logger Object with methods 'trace','debug','info','warn','error','fatal', 'mark'. Each of them having a string as input parameter
...
exports.RequestOptions = function RequestOptions(init) {
    ...
    /**
     * Function called for loading a modul. The module is a bag for functions used at exit points
