...
entity                   = o:object es:(MWS entityset )? w:(MWS with)? k:(MWS keys)? ct:(MWS concurrencytoken)? rt:(MWS retain_order)? n:(MWS navigates)? ge:(MWS globalExpand)? a:(MWS aggregates )? p:(MWS parameters)? m:(modifications)? scopes:(MWS scopes)?
                           {
                                var ret =  {};
